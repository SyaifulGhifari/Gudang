...
- [x] Product list page dengan search/filter
- [x] Product detail page
- [x] Product create form
- [x] Product edit form
- [x] Archive product functionality
- [x] Product table component
- [x] Pagination component

### Phase 3: Stock Management
- [x] Stock management hub / tabs
- [x] Barang masuk form & list
- [x] Barang keluar form & list
- [x] Penyesuaian stok form & list
- [x] Stock history view
- [x] Display current_stock from backend & manual refresh handling
- [x] Frontend validation untuk prevent UX mistakes (backend validates critical rules)
